// Life Events Data - Converted from Gina's events.yml
// Original source: /temp/life-in-weeks/data/events.yml
  ...
  "1980-09-01": [
    {
      ...
      description: "Went to Tiny Tot Schoolhouse, where Miss Mary and Miss Nini were my teachers.",
      based: "Brooklyn",
      doing: "Kindergartner",
  ...
  "1981-09-01": [
    {
      ...
      description: "Went to Catholic school, with uniforms, nuns, mass, and all.",
      based: "Brooklyn",
      doing: "Student",
      association: "St. E"
    }
...
// Configuration constants from Gina's implementation
export const WEEKS_CONFIG = {
  startDate: "1975-09-19",
  endYear: 2075,
  startYear: 1975,
  startMonth: "09",
  startDay: "19"
